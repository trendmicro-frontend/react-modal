...
/***/ function(module, exports, __webpack_require__) {
	...
	function instantiateReactComponent(node) {
	  ...
	  if (process.env.NODE_ENV !== 'production') {
	    process.env.NODE_ENV !== 'production' ? warning(typeof instance.mountComponent === 'function' && typeof instance.receiveComponent === 'function' && typeof instance.getNativeNode === 'function' && typeof instance.unmountComponent === 'function', 'Only React Modals can be mounted.') : void 0;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactMount = {
	  ...
	  renderSubtreeIntoContainer: function (parentComponent, nextElement, container, callback) {
	    !(parentComponent != null && parentComponent._reactInternalInstance != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'parentComponent must be a valid React Modal') : invariant(false) : void 0;
